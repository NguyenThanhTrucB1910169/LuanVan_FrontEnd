    ...
    return (
      <Fragment>
        <div className="my-3 product-card">
          <img src={`http://localhost:3005/uploads/${this.state.arrayImages.length === 3 ? this.state.arrayImages[2] : this.state.arrayImages[1]}`} alt="" className="h-100 w-100" />
            ...
            <div className="carditem">
              <div className="row img-slide">
                ...
                <div className="col-10 p-0">
                  <img
                    src={`http://localhost:3005/uploads/${this.state.arrayImages[this.state.slideIndex]}`}
